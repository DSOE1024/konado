...
<span class="line"><span>set %unlocked true</span></span></code></pre></div><hr><h2 id="變數插值" tabindex="-1">變數插值 <a class="header-anchor" href="#變數插值" aria-label="Permalink to &quot;變數插值&quot;">​</a></h2><p>在對話文字中直接使用 <code>%變數名</code> 或 <code>$變數名</code> 引用變數值，執行時會被替換為實際值。</p><h3 id="語法" tabindex="-1">語法 <a class="header-anchor" href="#語法" aria-label="Permalink to &quot;語法&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&quot;角色名&quot; &quot;對話文字，包含 %變數名 或 $變數名&quot;</span></span></code></pre></div><h3 id="範例-1" tabindex="-1">範例 <a class="header-anchor" href="#範例-1" aria-label="Permalink to &quot;範例&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>set %player_name &quot;小明&quot;</span></span>
<span class="line"><span>set $stage &quot;新手村&quot;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        dialogue_manager</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">variable_store </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> store</span></span></code></pre></div><h3 id="臨時變數" tabindex="-1">臨時變數（$） <a class="header-anchor" href="#臨時變數" aria-label="Permalink to &quot;臨時變數（$）&quot;">​</a></h3><p>臨時變數無需預設，在腳本中首次使用 <code>set</code> 時會自動建立。切換鏡頭時會自動重設。</p><hr><h2 id="完整範例" tabindex="-1">完整範例 <a class="header-anchor" href="#完整範例" aria-label="Permalink to &quot;完整範例&quot;">​</a></h2><p>以下是一個綜合示範，涵蓋所有變數功能：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>play bgm echo</span></span>
