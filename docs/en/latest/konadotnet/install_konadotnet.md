...
`DialogueManagerAPI` requires a `KND_DialogueManager` node that satisfies the complete
public API contract. Konadotnet binds it automatically when it enters the scene tree;
